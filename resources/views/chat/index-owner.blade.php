                ...
                <div class="panel-body chat"> 
                    <div class="row chat-wrapper">  
                                    ...
                                    <ul class="chat-list">
                                      @foreach ($requests as  $request)
                                          ...
                                          <li class="new" class="active">
                                            <a href="{{ route('showOwnerContactMessages', ['reference' => request()->route('reference'), 'request_id' => $request->reference]) }}">
                                              <span class="avatar available">
                                                  <img src="{{ asset('storage/'.$request->proof) }}" alt="avatar" class="img-circle">
                                              </span>
                                              <div class="body">
                                                  <div class="header">
                                                      <span class="username">{{ $request->title }}</span>
                                                      <small class="timestamp text-muted">
                                                          <i class="fa fa-clock-o"></i>{{ $request->created_at }}
                                                      </small>
                                                  </div>
                                                  <p>
                                                    {{ $request->message }}
                        ...
                        <div class="col-md-8">
                            ...
                            <div>
                                ...
                                <div class="message-list-wrapper" style=" width: auto; height: 452px;">
                                    <ul class="message-list">
                                        @foreach ($requests[0]->chat as $message)                                            
                           ...
                           @else
                              <div class="text-center col-md-12 h3"><- Select A Request to reply</div>
                           @endif
                        </div> 
